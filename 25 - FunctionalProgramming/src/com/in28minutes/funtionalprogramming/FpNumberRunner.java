...
//		streamTerminalOperations();
	...
	static void optionalClass() {
		Optional<Integer> int1 = List.of(23, 45, 67, 12).stream().filter(n -> n % 2 == 0)
				.max((n1, n2) -> Integer.compare(n1, n2));

		System.out.println("value:\t" + int1.get());
		System.out.println("pres:\t" + int1.isPresent());
		System.out.println("orElse:\t" + int1.orElse(0));

//		Optional<Integer> int2 = List.of(23, 45, 67, 35).stream().filter(n -> n % 2 == 0)
//				.max((n1, n2) -> Integer.compare(n1, n2));
//
//		System.out.println("value:\t" + int2.get());
//		System.out.println("pres:\t" + int2.isPresent());
//		System.out.println("orElse:\t" + int2.orElse(0));
